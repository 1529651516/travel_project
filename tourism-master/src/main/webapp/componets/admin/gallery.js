...
$(function(){
    ...
    function bindDataTables(){
        $("#datatable").dataTable({
            ...
            destroy:true,
            "sAjaxSource": "../gallery/getGalleryList",
    ...
    $('#datatable').on( 'click', 'a', function () {
        ...
        if($(this).attr("class")=="detail"){
            //console.log("打开编辑框");
            //addLabel(id);
            window.location.href="../gallery/update?id="+id;
...
function preImg(sourceId, targetId) {
    ...
    var imgPre = document.getElementsByName(targetId);
    imgPre.item(0).src = url;
    //$("photo").show();
    imgPre.item(0).style.display = "";
}
