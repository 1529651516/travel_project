...
public class HotelServiceImpl implements HotelService {
    ...
    public Page<Hotel> findAll( String sPrice, String ePrice, String star, Pageable pageable) {
        return hotelDao.findAll(Specifications.where(getWhereClause( sPrice, ePrice, star)),pageable);
    }

    public Specification<Hotel> getWhereClause( final String sPrice, final String ePrice, final String star) {
    ...
    public int upload(HttpServletRequest request, HttpServletResponse response) {
        ...
        try{
            ...
            if(StringUtils.isNotEmpty(h.getId())){
                if(h.getImg()==null){
                    Hotel hotel=hotelDao.findById(h.getId());
