...
public class SceneryServiceImpl implements SceneryService{
    ...
    public Page<Scenery> findAll(String star, String address,Pageable pageable) {
        return sceneryDao.findAll(Specifications.where(getWhereClause( star,address)),pageable);
    }

    public Specification<Scenery> getWhereClause(  final String star,final String address) {
    ...
    public int upload(HttpServletRequest request, HttpServletResponse response) {
        ...
        try{
            ...
            if(StringUtils.isNotEmpty(cf.getId())){
                if(cf.getImg()==null){
                    Scenery scenery=sceneryDao.findById(cf.getId());
                    cf.setImg(scenery.getImg());
                }
